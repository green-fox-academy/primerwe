...
let anotherData = data.split("\n");
let newData = anotherData.map(function (x) {
    return { 'name': x.split(';')[0], 'id': x.split(';')[1], 'color_code': x.split(';')[2] }
});

let unique = [];
let uniqueData = newData.filter(function (i) {
