...
print(post1.title + " titled by " + post1.author_name + " at " + post1.publication_date)
print(post2.title + " titled by " + post2.author_name + " at " + post2.publication_date)
print(post3.title + " titled by " + post3.author_name + " at " + post3.publication_date)